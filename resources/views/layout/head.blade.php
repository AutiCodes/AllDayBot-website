<head>
  ...
  <link rel="icon" href="{{ URL::asset('/assets/ADBlogo.png') }}" type="image/x-icon"/>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="/bot/power">Starten/Stoppen</a>
            <a class="dropdown-item" href="/bot/resources">Resources</a>
